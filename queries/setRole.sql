...
GRANT
SELECT
    ON hospital_management.appointments TO doctor,
    nurse,
    adminStaff;

GRANT
SELECT
    ON hospital_management.departments TO doctor,
    nurse,
    adminStaff;

GRANT
SELECT
    ON hospital_management.patients TO doctor,
    nurse,
    adminStaff;

GRANT
SELECT
    ON hospital_management.staff_job_history TO doctor,
    nurse,
    adminStaff;

GRANT
SELECT
    ON hospital_management.staffs TO doctor,
    nurse,
    adminStaff;
...
GRANT EXECUTE ON PROCEDURE hospital_management.R_ViewOneJobChangeHistoryByID TO adminStaff;
...
GRANT EXECUTE ON PROCEDURE hospital_management.S_GetAllDepartment TO doctor;

GRANT EXECUTE ON PROCEDURE hospital_management.S_GetStaffByUsername TO doctor;
...
GRANT EXECUTE ON PROCEDURE hospital_management.S_ViewStaffScheduleByID TO nurse;
...
GRANT EXECUTE ON PROCEDURE hospital_management.S_GetStaffByUsername TO nurse;

GRANT EXECUTE ON PROCEDURE hospital_management.S_GetAllDepartment TO nurse;
...
GRANT EXECUTE ON PROCEDURE hospital_management.S_GetStaffByUsername TO adminStaff;

GRANT EXECUTE ON PROCEDURE hospital_management.S_GetAllDepartment TO adminStaff;

GRANT EXECUTE ON PROCEDURE hospital_management.A_ViewDoctorScheduleByDuration TO adminStaff;

GRANT EXECUTE ON PROCEDURE hospital_management.S_ViewStaffScheduleByID TO doctor;
